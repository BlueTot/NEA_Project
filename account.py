...
class GameMilestones:  # Game Milestones class
    ...
    MILESTONES = {1: 10, 2: 20, 3: 35, 4: 60, 5: 100, 6: 180,
                  7: 270}  # Number of completions for each milestone dictionary
    ...
    REWARDS = {"4x4": {1: ("H", 1), 2: ("H", 2), 3: ("H", 4), 4: ("H", 6), 5: ("H", 9), 6: ("H", 14), 7: ("H", 20)},
               ...
               "16x16": {1: ("H", 5), 2: ("H", 8), 3: ("H", 11), 4: ("H", 15), 5: ("H", 19), 6: ("H", 24),
...
class AppearanceConfiguration:  # Appearance Configuration class
    ...
    def __init__(self, settings: list):  # Constructor
        if settings is not None:  # Signed In
            ...
            self.__background_colour, self.__colour1, self.__colour2, self.__colour3, self.__colour4, self.__title_font, self.__regular_font = settings[
                                                                                                                                               :-5]
