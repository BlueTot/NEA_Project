...
class GameMilestonesScreen(Screen):
    ...
    def __init__(self, account, max_size):
        ...
        for vidx, board_size in enumerate(milestone_types):
            for hidx, milestone_num in enumerate(range(1, 8)):
                ...
                box.setStyleSheet(f"background: {self._account.app_config.killer_colours[3] if self.__complete(board_size, milestone_num) else 'rgb(175, 175, 175)'}; border: 3px solid black;")
    ...
    def __view_game_milestone(self, board_size, milestone_num):
        ...
        self.__claim_reward.setStyleSheet(f"background: {self._account.app_config.killer_colours[3] if self.__complete(board_size, milestone_num) else 'rgb(175, 175, 175)'}; border: 3px solid black;")
...
class HelpScreen(Screen):
    ...
    def __init__(self, account, max_size):
        ...
        self.__txt_window = TextEdit(self, 100, 20, 800, 520, "white", 5, self._account.app_config.regular_font, 16)
